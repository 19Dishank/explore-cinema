...
const AxiosMovieCard = ({ ele }) => {
    ...
    return (
        ...
        <div className="w-full max-w-75 bg-slate-900 rounded-xl overflow-hidden shadow-xl border border-slate-800 flex flex-col transition-transform hover:scale-[1.02]">
